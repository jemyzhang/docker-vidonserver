<div class="posterMenu">
	<a href="javascript:;" class="backbtn click_backvideo">{$P.title.index_40}</a>
</div>
...
<div class="details_poster box_big">
	<div class="pic_big">
			<div fileid="{$T.idfile}" filepath="{$T.filepath}" style="background-image:url({$T.thumbnail});"  class="img">
...
<div class="detail_jt" id="video_detail_jt">
